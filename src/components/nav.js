        ...
        <div className="w-full">
            <div className="hidden sm:block fixed top-0 left-0 h-full w-fit md:w-[20%] lg:w-[20%] max-w-64 bg-slate-900 text-white  border-r-gray-300 border-r-2 px-1 ">
                <div className="my-10 py-5 pt-5">
                    ...
                    {/* <h2 className="text-black text-center font-bold font-title text-xl sm:text-gray-500">My Blog </h2> */}
                 
                </div>
                <div className="flex flex-col mt-[100px] w-full  gap-10 items-center">
                    <SearchBar/>
                    <Link className='w-full px-2' to='/home/blogs'>
                        <Button size={'small'}  className="w-[100%] hover:bg-gray-200 rounded-lg" >Home</Button>
                    </Link>
                    <Link className='w-full px-2' to='#'>
                        <Button onClick={()=>setViewSearchBar(!viewSearchBar)} size={'small'}  className="w-full hover:bg-gray-200 rounded-lg" >Search</Button>
                        {viewSearchBar && <SearchBar className={'w-full'}/>}
                    </Link>
